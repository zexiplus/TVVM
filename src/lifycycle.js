class Lifecycle {
  ...
  init(options, vm) {
    const { beforeCreate, created, beforeMount, mounted, beforeUpdate, updated, beforeDestory, destoried } = options
    const hooks = { beforeCreate, created, beforeMount, mounted, beforeUpdate, updated, beforeDestory, destoried }
